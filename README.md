...
recherche d'adresse (Nominatim), itinéraires réels (OSRM), signalements simulés pour les villes de Saint-Etienne (ville d'origine) et Lyon (ville de l'établissement) avec deux boutons ajoutés dans le header pour faciliter la démo.
